...
Inert `@route` metadata/discovery/binding is implemented as focused Python-reference-host internal support. `@server`, `@cors`, `genia serve`, listener activation, and live lifecycle-to-HTTP integration remain unimplemented.
