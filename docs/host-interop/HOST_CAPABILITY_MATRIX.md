...
| HTTP outbound transport | Python-host-only | Not Implemented | Not Implemented | Not Implemented | Not Implemented | Not Implemented | R14 E14-6 private capability, no Genia surface; one synchronous `urllib.request` attempt, no redirects/retries, closed timeout/connect/tls/dns/other failure kind; consumed internally by `web.http_send` (E14-7) and, through it, `web.send_annotated` (E14-9) |
| refs | Implemented | Not Implemented | Not Implemented | Not Implemented | Not Implemented | Not Implemented | Portable R25 contract; Python passes shared evidence; C++ is E25-1 |
| cell primitives | Implemented | Not Implemented | Not Implemented | Not Implemented | Not Implemented | Not Implemented | Portable R25 `cell_primitives` contract; Python passes shared evidence; C++ is E25-2 |
| process primitives | Implemented | Not Implemented | Not Implemented | Not Implemented | Not Implemented | Not Implemented | Portable local R25 contract; Python passes shared evidence; C++ is E25-3; not Actor or external `execution.process` |
