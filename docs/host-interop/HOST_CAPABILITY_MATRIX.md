...
| deterministic model fixture | Python-host-only | Not Implemented | Not Implemented | Not Implemented | Not Implemented | Not Implemented | Offline E11-1/E11-4 fixture injected only for explicitly selected shared eval/error/Flow/CLI spec and test environments; no real provider or ambient binding |
