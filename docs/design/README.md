...
- **r9-value-template-representation-contract.md** — approved R9 design contract with implementation status identified per slice; E9-1 through E9-7 are implemented and later sections remain planned.
