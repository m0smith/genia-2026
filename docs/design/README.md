...
- **r9-value-template-representation-contract.md** — approved R9 design contract for templates, carrier representations, patterns, rendering terminology, and the JSON boundary; not implemented behavior.
