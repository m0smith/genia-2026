...
- **r10-configuration-protected-value-contract.md** — approved R10 configuration and protected-value contract; E10-1 provider/ordinary acquisition implemented; later slices not implemented.
