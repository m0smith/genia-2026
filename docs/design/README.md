...
- **r10-configuration-protected-value-contract.md** — approved R10 configuration and protected-value contract; E10-1 through E10-7 implemented; E10-8 release truth audit in progress.
