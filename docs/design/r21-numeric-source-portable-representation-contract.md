...
The decisions below carry forward the approved Exact Numeric Model design work from issue #838 / PR #839 as historical design evidence; this merged contract is the release-owned planning authority for R21.
