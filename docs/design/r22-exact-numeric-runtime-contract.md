...
Immutable source design evidence: PR #839 head `856616e66028f00c51fb7aea2df7d0527ce8996f`, especially `docs/design/exact-numeric-model-contract.md` sections 3–10 and 15–18.
