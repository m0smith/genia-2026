...
Status: **Approved contract; E12-1 through E12-4 implemented as Experimental. E12-5 and later are not implemented.**
...
and E12-4 implements `retrieve/4` without adding a Template/representation/matcher-family builtin. Their
...
#643 through #646 completed E12-1 through E12-4 through their own phase gates.
Those implementations do not authorize E12-5 or later work, which
