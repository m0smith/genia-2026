...
| protected value | List/map/pipeline/Seq/Flow/Sheet | E10-3 transport preserves exact protected leaves and containers do not gain hidden taint; recursive sink rejection remains E10-4 | Transport implemented, Experimental; sinks later |
