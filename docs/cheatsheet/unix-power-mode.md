...
- `examples/r9_composed_json_template_pipeline.genia` is the directly tested composed pipeline: JSON boundary → represented-value match → JSON Schema-derived Template → `validate_each` → `collect_validated`.
