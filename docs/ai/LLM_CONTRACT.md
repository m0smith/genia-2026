...
## Release Position: R9 and R10 Complete; R11 E11-1 through E11-5 Implemented
...
**R11 — AI Composition is active and E11-1 through E11-5 are implemented.** The Experimental
...
6. Describe only R11 E11-1 through E11-5 as implemented; do not create AI value/class
  ...
  list/Flow `scan`, not a conversation runtime; E11-6 and later tickets require their own phase gates.
