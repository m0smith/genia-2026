...
contract and its E10-1 provider acquisition, E10-2 defaults/conversion-validation, and E10-3 protected-carrier/matching slices are implemented.**
...
5. Preserve the completed R9 Template/representation boundary and implemented
   R10 E10-1/E10-3 provider/defaulting/protected-carrier boundary; later R10 behavior remains
