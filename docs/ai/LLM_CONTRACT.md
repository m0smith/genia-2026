...
8. R13 is active (epic #608): E13-0 is approved and E13-1 through E13-7 are implemented. Preserve its boundary: views explicitly
   ...
   E13-7 adds documentation and runnable-example verification only; E13-8 remains separately gated. Follow `docs/strategy/r13-configuration-resolution-ergonomics.md`.
