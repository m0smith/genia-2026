...
COMPOSABILITY MATRIX DRIFT CHECK
...
- Does the matrix still carry its `PROPOSED / EXPLORATORY` status and
  `GENIA_STATE.md` is final authority disclaimer?

Reference: docs/design/composability-matrix.md
