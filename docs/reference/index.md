...
| [`lifecycle_child`](functions/lifecycle_child.md) | Lifecycle | `lifecycle_child(scope_handle, peers, work)` | Run one synchronous child execution scope under an active parent. |
| [`lifecycle_context`](functions/lifecycle_context.md) | Lifecycle | `lifecycle_context(scope_handle, name)` | Read one inward-visible context value through an active execution scope. |
| [`lifecycle_scope`](functions/lifecycle_scope.md) | Lifecycle | `lifecycle_scope(peers, work)` | Run one explicit root execution scope. |
...
- [`lifecycle_child`](functions/lifecycle_child.md) - Run one synchronous child execution scope under an active parent.
- [`lifecycle_context`](functions/lifecycle_context.md) - Read one inward-visible context value through an active execution scope.
- [`lifecycle_scope`](functions/lifecycle_scope.md) - Run one explicit root execution scope.
