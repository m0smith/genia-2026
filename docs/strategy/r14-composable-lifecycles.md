...
Status: **Active release; E14-0 contract approved and E14-1 implemented.**
Only the E14-1 root/child execution-scope slice is implemented. This document records approved release
direction; the contract document is the implementation-ready boundary.
...
2. **#621 — E14-1: lifecycle instance and parent/child execution scopes**
   - Implement the smallest HTTP-free instance/scope core.
...
**E14-1 is implemented by #621**, after #620 completed the current preflight,
mandatory portability analysis, and explicitly approved contract in
`docs/design/r14-composable-lifecycle-contract.md`. Later tickets remain
blocked until each completes its own preflight,
