...
E15-0 / issue #726 completed the contract, roadmap reconciliation, and capability-inventory gate through PR #738. **#728 / E15-1**, **#729 / E15-2**, **#730 / E15-3**, and **#731 / E15-4 — faithful supported Template → JSON Schema generation** are implemented (see `docs/releases/R15.md`). The next authorized work item is **#732 / E15-5 — structural discriminated alternatives**.
