...
E15-0 / issue #726 completed the contract, roadmap reconciliation, and capability-inventory gate through PR #738. **#728 / E15-1** through **#732 / E15-5 — structural discriminated alternatives** are implemented (see `docs/releases/R15.md`). The next authorized work item is **#733 / E15-6 — bounded named recursive Template references**.
