...
E15-0 / issue #726 completed the contract, roadmap reconciliation, and capability-inventory gate through PR #738. **#728 / E15-1 — inert inspectable Template descriptions** and **#729 / E15-2 — explicit missing-field defaults and normalization composition** are implemented (see `docs/releases/R15.md`). The next authorized work item is **#730 / E15-3 — accumulated path-aware validation diagnostics**.
