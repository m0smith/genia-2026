...
E10-2 defaults/conversion/Template validation, E10-3 protected-carrier/matching, and E10-4 protected-sink safety are implemented; later work still requires the repository's contract, design, test,
