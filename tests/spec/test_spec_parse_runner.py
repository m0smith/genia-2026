...
@pytest.mark.parametrize("source,expected", [
    ("42", {"kind": "ok", "ast": {"kind": "Literal", "value": {"kind": "integer", "digits": "42"}}}),
    ("x = 1", {"kind": "ok", "ast": {"kind": "Assign", "name": "x", "value": {"kind": "Literal", "value": {"kind": "integer", "digits": "1"}}}}),
    ("inc(x) -> x + 1", {"kind": "ok", "ast": {"kind": "FuncDef", "name": "inc", "params": ["x"], "body": {"kind": "Binary", "op": "+", "left": {"kind": "Var", "name": "x"}, "right": {"kind": "Literal", "value": {"kind": "integer", "digits": "1"}}}}}),
])
