"""Shared-spec inventory/execution contract for E15-2 (#729) Template defaults."""
...
REQUIRED = {
    "eval": {
        "template-default-field-missing-uses-default",
        "template-default-field-present-invalid-fails",
        "template-default-field-multiple-defaults",
        "template-default-field-nested-shape",
        "template-default-field-description-hides-value",
        "template-default-field-normalization-pipeline",
    },
    "error": {
        "error-default-field-template-type",
    },
}


def test_issue_729_template_defaults_shared_spec_inventory_is_present():
...
def test_issue_729_template_defaults_shared_specs_execute_as_contract():
    failures_by_name = {}
    for category, names in REQUIRED.items():
