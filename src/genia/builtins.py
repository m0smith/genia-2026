...
def make_global_env(
    ...
    def cors_fn(policy_value: Any, handler: Any) -> Callable[[Any], GeniaMap]:
        ...
        headers_value = policy_value.get("headers", ["content-type"])
