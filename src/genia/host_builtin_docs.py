...
_PUBLIC_DOCS = (
    ...
    _public("lifecycle_child", "Run one synchronous child execution scope under an active parent.", "Lifecycle", "lifecycle_child(scope_handle, peers, work)", stability="Experimental"),
    _public("lifecycle_context", "Read one inward-visible context value through an active execution scope.", "Lifecycle", "lifecycle_context(scope_handle, name)", stability="Experimental"),
    _public("lifecycle_scope", "Run one explicit root execution scope.", "Lifecycle", "lifecycle_scope(peers, work)", stability="Experimental"),
