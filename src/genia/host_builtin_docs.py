...
_PUBLIC_DOCS = (
    ...
    _public("exact", "Convert an exact numeric value or Float64 to the exact family (Integer/Decimal/Rational), denoting a finite Float64's precise represented binary64 value.", "Numeric", "exact(value)", stability="Experimental"),
    _public("exact_shape", "Construct an inspectable exact-shape Template from a field Templates map.", "Value templates", "exact_shape(fields)", stability="Experimental"),
    ...
    _public("float64", "Convert an exact numeric value to an explicit IEEE-754 binary64 Float64, or return an existing Float64 unchanged.", "Numeric", "float64(value)", stability="Experimental"),
    ...
    _public("open_shape", "Construct an inspectable open-shape Template from a field Templates map.", "Value templates", "open_shape(fields)", stability="Experimental"),
    ...
    _public("rational", "Construct a canonical exact Rational from an Integer numerator and denominator.", "Numeric", "rational(numerator, denominator)", stability="Experimental"),
