...
_PUBLIC_DOCS = (
    ...
    _public("exact", "Convert a finite Float64 to the exact Decimal it represents, or return an already-exact Integer/Decimal/Rational unchanged.", "Numeric", "exact(value)", stability="Experimental"),
    ...
    _public("float64", "Construct an explicit IEEE-754 binary64 Float64 from an exact numeric value, or return an existing Float64 unchanged.", "Numeric", "float64(value)", stability="Experimental"),
...
_execution_process _find _flat_map_some _flow? _flow_debug _flush _format
_format_compose _get
