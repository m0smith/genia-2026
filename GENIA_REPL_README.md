...
- runtime value categories today:
  ...
  - runtime capability values:
    ...
    - portable capability values implemented by Python: Ref, Cell, and local Process handle (R25 E25-0 shared-evidenced; C++ implementation pending E25-1 through E25-3)
...
- builtins:
  ...
  - R25-portable ref runtime helpers are exposed publicly through prelude-backed wrappers: `ref`, `ref_get`, `ref_set`, `ref_is_set`, `ref_update` (Python implemented/evidenced; C++ pending E25-1)
  - R25-portable local process runtime helpers are exposed publicly through prelude-backed wrappers: `spawn`, `send`, `process_alive?` (Python implemented/evidenced; C++ pending E25-3; Actor excluded)
