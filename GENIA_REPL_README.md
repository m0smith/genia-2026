...
- runtime value categories today:
  ...
  - runtime capability values:
    ...
    - Experimental R12 E12-2 `embed/4`, E12-3 `index/4`, and E12-4 `retrieve/4` return ordinary callables over explicit opaque Python fixture capabilities; retrieval consumes an explicit query embedding plus paired opaque handle, checks identity/space/dimensions before one authorized attempt, and returns ordered exact evidence or `none("retrieval-no-results")`; reranking and later R12 behavior are unimplemented
