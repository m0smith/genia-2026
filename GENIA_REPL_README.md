...
- runtime value categories today:
  ...
  - runtime capability values:
    ...
    - Experimental R12 E12-2 `embed/4`, E12-3 `index/4`, E12-4 `retrieve/4`, and E12-5 `rerank/4` return ordinary callables over explicit opaque Python fixture capabilities; retrieval returns ordered exact indexed evidence or no-results absence, and provider reranking may reorder/rescore only while preserving its exact duplicate-aware chunk/provenance multiset; grounding and later R12 behavior remain unimplemented
