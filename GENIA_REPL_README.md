...
- builtins:
  ...
  - R13 E13-6 proves the existing Outcome-aware validated-pipeline composition, and E13-7 synchronizes runnable release examples and public truth without runtime changes; R13 remains Active and Experimental, Python is the only implemented host, shared/multi-host conformance remains Partial, and E13-8 remains separately gated
