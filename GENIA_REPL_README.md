...
- runtime value categories today:
  ...
  - runtime capability values:
    ...
    - Experimental R12 E12-2 `embed/4` and E12-3 `index/4` return ordinary callables over explicit opaque Python fixture capabilities; indexing validates a nonempty compatible embedded corpus before one authorized attempt and returns only an opaque `<index-handle>`; retrieval and later R12 behavior are unimplemented
