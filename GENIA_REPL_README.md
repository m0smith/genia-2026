...
- runtime value categories today:
  ...
  - runtime capability values:
    ...
    - Experimental text or R9-validated JSON model callables created by `model/4` from an explicitly host-injected provider, protected credential, and authority; E11-3 adds one explicitly constructed Python-host Gemini REST capability alongside the offline deterministic fixture, with no ambient REPL binding
