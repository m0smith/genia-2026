...
**R11 — AI Composition is active and E11-1 through E11-5 are implemented.** Its Experimental
...
fixture hardening plus E11-5 application-owned list/Flow `scan` conversation composition. E11-6 and later slices remain unimplemented
