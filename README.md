...
R13 E13-7 adds no runtime behavior. It synchronizes the active release page and focused executable documentation coverage with the implemented E13-1 through E13-6 boundary. The APIs remain Experimental, Python is the only implemented host, shared/multi-host conformance remains Partial, and E13-8 remains separately gated.
