...
The directly tested [`examples/r9_composed_json_template_pipeline.genia`](examples/r9_composed_json_template_pipeline.genia) combines this boundary and Template with representation-aware matching, `validate_each`, and `collect_validated`. It is an integration example and adds no new language behavior.
