...
- Eval/error cases may replace `input.source` with the portable logical
  `input.modules` fixture defined in
...
- Proven at full scale in `tests/spec/
  test_python_protocol_adapter_parity_762.py` (marked `slow` and
