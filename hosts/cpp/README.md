...
C++ lexer/parser/evaluator bring-up is now planned for R24
(`docs/strategy/roadmap/r21-r24.md`), after R21-R23 exact-numeric work is
completed and audited, and happens entirely in `m0smith/genia-cpp`, not here.
